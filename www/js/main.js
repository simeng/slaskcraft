...
(function () {
    ...
    function loadPlayerLinks(callback) {
        d3.json("/json/players.json", function(err, players) {
            var cam_accounts = ['Notch', 'ShreeyamGFX', 'Coestar', 'Dinnerbone', 'UelandCam', 'AtillaTari', 'einarcam', 'hildenae', 'sakecam', 'afarberg', 'Hanyu_Furude','Kagee_Kamera', 'Tonje', 'linselus'];
